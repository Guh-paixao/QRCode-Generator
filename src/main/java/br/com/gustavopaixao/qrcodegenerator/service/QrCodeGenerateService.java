package br.com.gustavopaixao.qrcodegenerator.service;

import br.com.gustavopaixao.qrcodegenerator.dto.qrcode.QrCodeGenerateResponse;
import br.com.gustavopaixao.qrcodegenerator.ports.StoragePort;
...
public class QrCodeGenerateService {
    ...
    public QrCodeGenerateResponse generateAndUploadQrCode(String text) throws WriterException, IOException {
        ...
        String url = storage.uploadFile(UUID.randomUUID().toString(), pngQrCodeData, "image/png");
